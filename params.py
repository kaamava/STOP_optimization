...
def get_args(description='DGL on Retrieval Task'):
    ...
    parser.add_argument('--use_relation_loss', type=int, default=0,
                            help="Set to 1 to enable relation JS loss between modalities.")
    parser.add_argument('--relation_loss_weight', type=float, default=0.0,
                            help="Weight applied to the relation JS loss when enabled.")
    parser.add_argument('--relation_loss_tau', type=float, default=0.1,
                            help="Temperature parameter for relation JS loss softmax.")
    ...
    ## phrase prompt related flags
    parser.add_argument('--use_phrase_prompt', action='store_true',
                        help='Enable phrase-level prompt aggregation inside the text branch.')
    parser.add_argument('--phrase_prompt_mode', type=str, default='learnable',
                        choices=['learnable', 'kmeans'],
                        help='Choose between learnable prototypes or on-the-fly kmeans-style clustering.')
    parser.add_argument('--phrase_clusters', type=int, default=5,
                        help='Number of phrase clusters (R) per layer.')
    parser.add_argument('--phrase_temperature', type=float, default=0.2,
                        help='Temperature used when computing token-to-phrase similarities.')
    parser.add_argument('--phrase_prompt_length', type=int, default=5,
                        help='Output phrase prompt length (defaults to number of clusters).')
    parser.add_argument('--phrase_share_layers', action='store_true',
                        help='Share phrase prompt parameters across transformer layers.')
    parser.add_argument('--phrase_residual_scale', type=float, default=1.0,
                        help='Scaling factor applied to the residual phrase prompts.')
    parser.add_argument('--phrase_kmeans_iters', type=int, default=2,
                        help='Number of refinement iterations for kmeans-style phrase prompts.')
